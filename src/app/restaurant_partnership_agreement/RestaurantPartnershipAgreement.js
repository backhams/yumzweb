            ...
            <div className='mx-auto px-4 sm:px-6 lg:px-8 pt-4 bg-black mt-48'>
                ...
                <div className='md:mx-28 mb-16'>
                    ...
                    <p className="mb-4 text-white">
                        These Terms and Conditions (&quot;Terms&quot;) govern your use of the Flavo platform (&quot;Platform&quot;) as a restaurant partner. By accessing or using the Platform, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use the Platform.
                    </p>
                    ...
                    <p className="mb-4 text-white">
                        3.1 You agree to pay a commission of 27% per order (the &quot;Commission&quot;) to Flavo for orders placed through the Platform.<br />
                        3.2 The Commission covers the use of the Platform, payment processing, marketing, and other associated costs.<br />
                        3.3 Flavo reserves the right to adjust the Commission percentage with prior notice to restaurant partners.
                    </p>
                    <h2 className="text-xl font-bold mb-2 text-white">Payment</h2>
                    <p className="mb-4 text-white">
                        4.1 Flavo will remit the payment for orders, minus the Commission, to the restaurant partner on a regular basis, as agreed upon between Flavo and the restaurant partner.<br />
                    ...
                    <p className="mb-4 text-white">
                        ...
                        5.5 In case of any delays or issues with order fulfillment, you are required to promptly notify the customer and Flavo.
                    </p>
                    <h2 className="text-xl font-bold mb-2 text-white">Cancellation and Refunds</h2>
                    <p className="mb-4 text-white">
                        6.1 You may cancel an order if it cannot be fulfilled due to reasons such as unavailability of ingredients or unforeseen circumstances. However, you must inform Flavo and the customer promptly.<br />
                        6.2 Refunds for canceled orders will be handled in accordance with the Flavo refund policy.
                    </p>
                    ...
                    <p className="mb-4 text-white">
                        ...
                        7.2 Flavo reserves the right to conduct periodic inspections or audits of your restaurant premises to ensure compliance with quality standards.
                    </p>
                    ...
                    <p className="mb-4 text-white">
                        9.1 Flavo may feature your restaurant and menu items in promotional campaigns, advertisements, or marketing materials to promote the Platform.<br />
                        9.2 You agree to cooperate with Flavo in promotional activities and provide any necessary assistance or materials as requested.
                    </p>
                    ...
                    <p className="mb-4 text-white">
                        11.1 You acknowledge and agree that Flavo may collect, store, and process personal data provided by you or generated through your use of the Platform in accordance with the Flavo Privacy Policy.
                    </p>
                    ...
                    <p className="mb-4 text-white">
                        ...
                        12.2 By listing your restaurant on the Platform, you grant Flavo a non-exclusive, worldwide, royalty-free license to use, display, and promote your restaurant name, logo, and menu for the purposes of operating and promoting the Platform.
                    </p>
                    <h2 className="text-xl font-bold mb-2 text-white">Indemnification</h2>
                    <p className="mb-4 text-white">
                        13.1 You agree to indemnify and hold harmless Flavo, its affiliates, officers, directors, employees, and agents from any claims, damages, losses, liabilities, costs, or expenses arising out of or related to your use of the Platform or any breach of these Terms.
                    </p>
                    <h2 className="text-xl font-bold mb-2 text-white">Termination</h2>
                    <p className="mb-4 text-white">
                        14.1 Flavo reserves the right to terminate or suspend your access to the Platform at any time, with or without cause, and without prior notice.<br />
                    ...
                    <p className="mb-4 text-white">
                        15.1 Flavo reserves the right to update or modify these Terms at any time, and any changes will be effective upon posting the revised Terms on the Platform. Your continued use of the Platform after the posting of changes constitutes your acceptance of such changes.
                    </p>
