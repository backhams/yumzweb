  ...
  return (
    <footer className="py-8 bg-black">
        ...
        <div className="flex flex-wrap justify-center">
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 mb-6 md:mb-0">
            ...
            <ul className="flex">
              ...
              <li className="mr-4"><a href="https://www.instagram.com/FleVo968" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-orange-500"><i className="fab fa-instagram"><SiInstagram /></i></a></li>
      ...
      <div className="text-center mt-4 text-white">
        &copy; {new Date().getFullYear()} FleVo. All Rights Reserved. Made with ❤️ by <Link href="https://xfery.com" className="text-blue-500">xfery.com</Link>
      </div>
    </footer>
  );
};
