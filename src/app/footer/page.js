        ...
        <div className="flex flex-wrap justify-center">
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 mb-6 md:mb-0">
            ...
            <ul className="flex">
              ...
              <li className="mr-4"><a href="https://www.instagram.com/yumz968" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-orange-500"><i className="fab fa-instagram"><SiInstagram /></i></a></li>
