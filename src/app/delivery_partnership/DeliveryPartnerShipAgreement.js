    ...
    return (
        <>
            ...
            <Navbar />
                ...
                <h2 className="text-xl font-bold mb-2">Responsibilities of the Company:</h2>
                ...
                <h2 className="text-xl font-bold mb-2">Responsibilities of the Delivery Partner:</h2>
                <ul className="list-disc ml-6 mb-4">
                ...
                <h2 className="text-xl font-bold mb-2">Failure to Deliver:</h2>
                <p className="mb-4">
